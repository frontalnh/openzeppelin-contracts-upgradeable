    ...
    IERC721EnumerableUpgradeable
{
    ...
    /**
     * @dev
     * `_maxBatchSize` refers to how much a minter can mint at a time.
     * `collectionSize_` refers to how many tokens are in the collection.
     */
    function __ERC721AUpgradable_init(
        string memory name_,
     ...
     * This read function is O(_collectionSize). If calling from a separate contract, be sure to test gas first.
